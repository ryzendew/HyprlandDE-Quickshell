...
Column {
    ...
    Rectangle {
        ...
        height: 50
        radius: 25
        color: Qt.rgba(Appearance.colors.colLayer1.r, Appearance.colors.colLayer1.g, Appearance.colors.colLayer1.b, 0.4)
        border.color: passwordField.activeFocus ? Appearance.colors.colPrimary : Qt.rgba(Appearance.colors.colOutline.r, Appearance.colors.colOutline.g, Appearance.colors.colOutline.b, 0.6)
        border.width: 2
        ...
        TextInput {
            ...
            Text {
                ...
                color: Qt.rgba(Appearance.colors.colOnLayer0.r, Appearance.colors.colOnLayer0.g, Appearance.colors.colOnLayer0.b, 0.7)
    ...
    Text {
        ...
        font.family: "FiraCode Nerd Font"
        font.pixelSize: 14
        color: authSuccess ? Appearance.colors.colSuccess : Appearance.colors.colPrimary
        text: {
